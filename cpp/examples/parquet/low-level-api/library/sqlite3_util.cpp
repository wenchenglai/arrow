...
string SqliteUtil::get_query_columns(string file_name) {
...
void SqliteUtil::print_dhl_sqlite_schema(string_map const &source_schema_map) {
...
int SqliteUtil::get_schema(string file_path, string_map& source_schema_map) {
    sqlite3* pDb;
    ...
    string query = get_query_columns(QUERY_COLUMNS_FILE_NAME) + " LIMIT 1;";
